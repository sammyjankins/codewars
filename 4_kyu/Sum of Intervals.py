...
def sum_of_intervals(intervals):
    return len(set([i for sample in intervals for i in range(*sample)]))


interval_1 = [(1, 5)]
interval_2 = [(1, 5), (6, 10)]
interval_3 = [(1, 5), (1, 5)]
interval_4 = [(1, 4), (7, 10), (3, 5)]

print(sum_of_intervals(interval_1))
print(sum_of_intervals(interval_2))
print(sum_of_intervals(interval_3))
print(sum_of_intervals(interval_4))
